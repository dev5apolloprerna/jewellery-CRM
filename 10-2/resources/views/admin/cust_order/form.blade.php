                    ...
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <a href="{{ route('custOrder.index', ['id' => $order->cust_id ?? $id]) }}"
                                      ...
                                      <div class="col-lg-6 col-md-6">
                                        ...
                                        <div class="card-footer mt-2">
                                            ...
                                            <button type="submit"
                                                ...
                                                @if(isset($order))
                                                 <a class="btn btn-primary float-right mr-3 mb-3 mx-2"  href="{{ route('custOrder.index', ['id' => $order->cust_id ?? $id]) }}">Cancel</a>
