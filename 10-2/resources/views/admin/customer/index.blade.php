                                    ...
                                    <tbody>
                                       @forelse ($customers as $cust)
                                            <tr>
                                                ...
                                                <td><h6><a href="{{ route('customer.history', $cust->customer_id) }}" class="mx-1">{{ $cust->customer_name }}</a></h6></td>
                                                ...
                                                <td>
                                                     <div>
                                                        <a class="mx-1" title="Edit"
                                                            href="{{ route('customer.edit', $cust->customer_id) }}">
                                                       ...
                                                       @if($cust->latestVisit)
                                                            @if($cust->latestVisit->followup_status == 1)
                                                                    <a class="mx-1" title="New Visit" href="{{ route('newVisite.create', $cust->customer_id) }}">
                                                                        <i class="fas fa-plus-circle"></i>
                                                                    </a>
                                                            @endif
                                                            @else
                                                            <a class="mx-1" title="New Visit" href="{{ route('newVisite.create', $cust->customer_id) }}"><i class="fas fa-plus-circle"></i>
                                                            </a>
                                                        @endif
                                                        ...
                                                        <a class="mx-1" title="Customer Previous Visit"
                                                            href="{{ route('newVisite.previous_visit', $cust->customer_id) }}">
                                                            <i class="fa fa-message"></i>
                                                        </a>
                                                        @endif
                                                        <a class="mx-1" title="Customer Order"
                                                            href="{{ route('customer.history', $cust->customer_id) }}">
                                                            <i class="fa fa-eye"></i>
                                                        </a> 
                                                        <!-- <a class="mx-1" title="Customer Order"
                                                            href="{{ route('custOrder.index', $cust->customer_id) }}">
