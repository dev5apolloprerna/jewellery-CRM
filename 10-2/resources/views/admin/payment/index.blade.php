                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="d-flex justify-content-between card-header">
                            ...
                            <a href="{{ route('custOrder.index') }}" class="btn btn-sm btn-primary" style="margin-left: 10px;">
                                    Back
                                </a>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="border p-3 mb-4">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <hr>
                                <div class="card-body">
                                 <h6 class="text-uppercase text-black fw-bold mt-4 mb-2">Add Payment Detail </h6>
...
<hr>
                                    {{-- Followup History --}}
                            <h6 class="text-uppercase fw-bold mt-4 text-black mb-2">Payment Detail</h6>
                            <table class="table table-bordered">
                                <thead>
                                    <th>No</th>
                                    <th>Amount</th>
...
<script>
 function viewData(orderId) {
        ...
        url: '/cust-order-detail/'+ orderId+'/edit' , // Correct full URL
        type: 'GET',
        dataType: 'json',
