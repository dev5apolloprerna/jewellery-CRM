                    ...
                    <div class="col-lg-12">
                        <div class="card">
                           <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="btn-group">
                                <a href="{{ route('custFollowup.createWithId', $id) }}" class="btn btn-sm btn-primary">
                                    ...
                                    <tbody>
                                       @forelse ($followups as $row)
                                            <tr>
                                                ...
                                                <td>
                                                    <div>                                                        
                                                        <a href="{{ route('custFollowup.edit', $row->followup_id) }}"><i class="fa fa-edit"></i></a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                        ...
                        <form action="{{ route('custFollowup.destroy', $row->followup_id ?? '') }}" id="user-delete-form" method="POST">
                            @csrf
