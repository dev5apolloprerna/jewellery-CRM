                    ...
                    <div class="col-lg-12">
                        <div class="card">
                           <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="btn-group">
                                <a href="{{ route('custOrderDetail.create', $order->order_id) }}" class="btn btn-sm btn-primary">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                        ...
                        <form action="{{ route('custOrderDetail.destroy', $detail->detail_order_id ?? '') }}" id="user-delete-form" method="POST">
                            @csrf
