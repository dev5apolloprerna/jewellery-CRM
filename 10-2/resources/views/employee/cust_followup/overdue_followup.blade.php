...
@section('title', 'Customer OverDue Followup')
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                           <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="card-title mb-0">Customer OverDue Followup</h5>
                            
                            
                        </div>

                             <!-- <div class="card-body">
                                <form method="POST" action="{{ route('EMPvisit.overdue') }}" class="row g-3 mb-4">
                                    @csrf
                                     <div class="row"> 
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="name">From Date </label>
                                                <input type="date" name="next_followup_date" value="{{ request('next_followup_date') }}" class="form-control">
                                            </div>
                                        </div>
                                                 ...
                                                 <td>
                                                    <div>
                                                        <a class="mx-1" title="Edit"
                                                            href="{{ route('EMPvisit.previous_visit_view', $visit->visit_id) }}">
