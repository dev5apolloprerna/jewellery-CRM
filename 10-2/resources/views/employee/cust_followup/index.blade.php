...
@section('title', 'Customer Followup List')
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                           <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="card-title mb-0">Customer Followup List</h5>
                            
                            <div class="btn-group">
                                <a href="{{ route('EMPcustFollowup.createWithId', $id) }}" class="btn btn-sm btn-primary">
                                    ...
                                    <tbody>
                                       @forelse ($followups as $row)
                                            <tr>
                                                ...
                                                <td>{{ date('d-m-Y',strtotime($row->next_date)) }}</td>
                                                <td>
                                                    <div>                                                        
                                                        <a href="{{ route('EMPcustFollowup.edit', $row->followup_id) }}"><i class="fa fa-edit"></i></a>
                                                         <a class="" href="#" data-bs-toggle="modal"
                                                                title="Delete" data-bs-target="#deleteRecordModal"
                                                                onclick="deleteData(<?= $row->followup_id ?>);">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                        ...
                        <form action="{{ route('EMPcustFollowup.destroy', $row->followup_id ?? '') }}" id="user-delete-form" method="POST">
                            @csrf
                            <input type="hidden" name="followup_id" id="deleteid" value="">
