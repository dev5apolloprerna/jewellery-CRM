                            ...
                            <form action="{{ route('empprofile.update') }}" method="POST">
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text"
                                            class="form-control @error('emp_phone') is-invalid @enderror"
                                            name="emp_phone" maxlength="10"
                                            value="{{ old('emp_phone') ? old('emp_phone') : auth()->user()->emp_phone }}" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"
                                    ...
                                    <div class="col-md-4 mt-4">
                                        <label class="labels">Secondary nPhone</label>
                                        <input type="text"
                                            class="form-control @error('emp_phone2') is-invalid @enderror"
                                            name="emp_phone2" maxlength="10"
                                            value="{{ old('emp_phone2') ? old('emp_phone2') : auth()->user()->emp_phone2 }}" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"
                                            placeholder="Mobile Number">
                                        @error('emp_phone2')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="col-md-4 mt-4">
                                        ...
                                        <input type="date"
                                            ...
                                            name="emp_dob"
                                            value="{{ old('emp_dob') ? old('emp_dob') : auth()->user()->emp_dob }}"
