                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Add Customer Product</h4>
                            <div class="page-title-right">
                                <a href="{{ route('EMPcustProduct.index', $id) }}"
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="live-preview">
                                          ...
                                          <form action="{{ route('EMPcustProduct.store') }}" method="POST">
                                                @csrf
                                        <div class="row gy-4">

                                                @include('employee.cust_product.form', ['custProduct' => null])
                                        </div>
