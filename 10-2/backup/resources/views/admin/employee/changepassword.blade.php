                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <a href="{{ route('empMaster.index') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Back</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <div class="tab-pane" id="changePassword" role="tabpanel">
                                        <form action="{{ route('empMaster.updatepassword',$userid) }}" method="POST">
                                            @csrf
