                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="live-preview">
                                      ...
                                      <form method="POST" action="{{ isset($detail)  ? route('custOrderDetail.update', $detail->detail_order_id) : route('custOrderDetail.store', $order->order_id) }}">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            ...
                                            <select name="branch_id" class="form-control" required>
                                                ...
                                                @foreach ($branches as  $b)
                                                    <option value="{{ $b->branch_id }}" {{ old('branch_id', $detail->branch_id ?? '') == $b->branch_id ? 'selected' : '' }}>
                                                        {{ $b->branch_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                      ...
                                      <div class="col-lg-6 col-md-6">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                          <label for="delivery_status" class="form-label">Delivery Status<span style="color:red;">*</span></label>
                                            <input type="text" name="delivery_status" class="form-control" placeholder="Enter Given To" value="{{ old('delivery_status', $detail->delivery_status ?? '') }}" maxlength="50" >
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                         ...
                                         <div class="card-footer mt-2">
                                            ...
                                            <a class="btn btn-primary float-right mr-3 mb-3 mx-2"
                                                href="{{ route('custOrder.index', ['id' => $order->cust_id ?? $id]) }}">Cancel</a>
                                                @else
