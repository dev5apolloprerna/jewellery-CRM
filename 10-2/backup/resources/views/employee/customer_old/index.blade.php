                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                     <div>
                                                        ...
                                                        <a class="mx-1" title="Customer Product"
                                                            href="{{ route('EMPcustProduct.index', $cust->customer_id) }}">
                                                            <i class="fas fa-box"></i>
                                                        </a>
                                                        <a class="mx-1" title="Customer Followup"
                                                            href="{{ route('EMPcustFollowup.index', $cust->customer_id) }}">
                                                            <i class="fa fa-message"></i>
                                                        </a>
                                                        <a class="mx-1" title="Customer Order"
                                                            href="{{ route('EMPcustOrder.index', $cust->customer_id) }}">
