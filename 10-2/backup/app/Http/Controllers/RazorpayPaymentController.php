    ...
    public function razorPaySuccess(Request $request)
    {
       try
       {
        ...
        if ($generated_signature == $razorpay_signature) {
            ...
            $address= $Order['shiiping_address1'] .','. $Order['shiiping_address2'].','.  $Order['shipping_city'].','.  $Order['state'].','.  $Order['shipping_pincode'];
            ...
            foreach ($cartItems as $cartItem) {
                ...
                <td style="text-align: center;" class="product-des" data-title="Description">
    				<p class="product-name">'.$cartItem['name'].'</p>
    	    	</td>
    			<td style="text-align: center;" class="image" data-title="No"><img src='.$cartItem['attributes']['image'].' alt="#" width="50px"></td>
    			<td style="text-align: center;" class="weight text-center" data-title="weight">'.$cartItem['weight'].'</td>
    			<td style="text-align: center;" class="qty text-center" data-title="Qty">'.$cartItem['quantity'].'</td>
    			<td style="text-align: center;" class="price text-right" data-title="Rate"><span> &#8377; '.$cartItem['price'].' </span></td>
    			
    			<td style="text-align: center;" class="total-amount text-right" data-title="Amount"><span> &#8377; '. $cartItem['price'] * $cartItem['quantity'] .'</span></td>
				</tr>';
            $i++;
            }
            ...
            $subject = "Order Detail From Sukti Order No :#".$Order['order_id'];
            $message = $file;
