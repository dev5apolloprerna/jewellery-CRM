                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            justify-content: space-between;">
                                ...
                                <a href="{{ route('vendorMaster.create') }}" class="btn btn-sm btn-primary">
                                    <i data-feather="plus"></i> Add New
                                </a>
                            </div>
                             <div class="card-body">
                                <form method="get" action="{{ route('vendorMaster.index') }}" id="myForm">
                                    @csrf
                                     <div class="row"> 
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label for="name">Search By Vendor Name</label>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                     <div>
                                                        ...
                                                        href="{{ route('vendorMaster.edit', $v->vendor_id) }}">
                                                        <i class="far fa-edit"></i>
                                                    </a>

                                                        <a class="" href="#" data-bs-toggle="modal"
                                                            title="Delete" data-bs-target="#deleteRecordModal"
                                                            onclick="deleteData(<?= $v->vendor_id ?>);">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                        ...
                        <form action="{{ route('vendorMaster.destroy', $v->vendor_id ?? '') }}" id="user-delete-form" method="POST">
                            @csrf
