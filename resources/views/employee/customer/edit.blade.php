    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="live-preview">
                                    ...
                                    <form action="{{ route('EMPcustomer.update', $customer->customer_id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div class="row gy-4">

                                        @include('employee.customer.form', ['customer' => $customer])
                                        ...
                                        <div class="card-footer mt-2">
                                            ...
                                            <a class="btn btn-primary float-right mr-3 mb-3 mx-2"
                                                href="{{ route('EMPcustomer.index') }}">Cancel</a>
                                        </div>
                                        </div>
                                    </form>
                                </div>
...
@section('scripts')
    ...
    function validatedata() { 
        ...
        var url = "{{ route('EMPcustomer.validateEditCustomer') }}";
        $.ajax({
            url: url,
            type: 'GET',
            data: {
