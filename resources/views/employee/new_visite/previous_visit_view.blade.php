                            ...
                            <form id="regForm" method="POST" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="row gy-4">
                                           ...
                                           <!--  <div class="col-lg-3 col-md-6">
                                                ...
                                                <input type="number" class="form-control" name="quantity" id="quantity" value="{{ old('quantity', $custProduct->quantity ?? '') }}" placeholder="Enter Quantity" maxlength="10" >
                                                    <span class="text-danger error-text" id="error-quantity"></span>
                                            </div> -->

                                            <!--<div class="col-lg-3 col-md-6">
                                                <label for="visit_date" class="form-label">Visit Date <span style="color:red;">*</span></label>
                                                <input type="date" class="form-control" name="visit_date" id="visit_date" value="{{ old('visit_date', \Carbon\Carbon::now()->format('Y-m-d')) }}"  placeholder="Enter Visit date" maxlength="100" >
                                                    <span class="text-danger error-text" id="error-visit_date"></span>
                                            </div>-->

                                            <div class="col-lg-2 col-md-6">
                                                Status <span style="color:red;">*</span>
                                                    <select class="form-control" name="status" id="productstatus" required>
                                                            <option value="view" {{ old('status', $custProduct->status ?? '') == 'view' ? 'selected' : '' }}>View</option>
                                                                <option value="delivered" {{ old('status', $custProduct->status ?? '') == 'delivered' ? 'selected' : '' }}>Delivered</option>
                                                    </select>
                                                    <span class="text-danger error-text" id="error-status"></span>
                                            </div>
...
$(document).on('click', '.orderProduct', function () {
    ...
    $.ajax({
        url: '/jewellery_crm/get-order-details/' + custProId, // You will need to create this route
        type: 'GET',
        success: function (response) {
