...
@section('title', 'Customer Order Detail List')
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                           <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="card-title mb-0">Customer Order Detail List</h5>
                            
                            <div class="btn-group">
                                <a href="{{ route('EMPcustOrderDetail.create', $order->order_id) }}" class="btn btn-sm btn-primary">
                                         ...
                                         @else
                                           @foreach($order->orderDetails as $index => $detail)
                                            <tr>
                                                ...
                                                <td>
                                                    <div>                                                        
                                                        <a href="{{ route('EMPcustOrderDetail.edit', $detail->detail_order_id) }}"><i class="fa fa-edit"></i></a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                        ...
                        <form action="{{ route('EMPcustOrderDetail.destroy', $detail->detail_order_id ?? '') }}" id="user-delete-form" method="POST">
                            @csrf
                            <input type="hidden" name="detail_order_id" id="deleteid" value="">
